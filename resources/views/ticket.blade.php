    ...
    <section class="container py-5">
        <div class="row text-center pt-3">
            <div class="col-lg-6 m-auto text-dark">
                <h1 class="h1" style="font-family: 'Poppins', sans-serif; font-weight: 800;"> <b>Pertandingan</b></h1>
                <p style="font-family: 'Poppins', sans-serif; font-weight: 700;">
                    Don't miss the next exciting match! Get your tickets now.
                </p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12 col-md-6 p-5 mt-3">
                <a href="#"><img src="/Asset/img/persib2.jpg" class="img-fluid border"></a>
                <h5 class="text-center mt-3 mb-3">Upcoming Match</h5>
                <p class="text-center">
                    <a class="btn btn-success" href="{{ route('pilihtribun') }}">Get Tickets</a>
                </p>
            </div>
        </div>
    </section>
