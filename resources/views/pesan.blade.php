        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <li class="scroll-to-section"><a href="#services">Tiket</a Tiket></li>
              <li class="scroll-to-section"><a href="#portfolio">Info</a></li>
